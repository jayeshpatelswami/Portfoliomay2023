...
const About = () => {
  return (
    <>
      <div id="about">
        ...
        {/* <div className="container mt-4">
          ...
          <div className="collapse" id="navbarToggleExternalContent">
            <div className="bg-dark p-4">
              <h5 className="text-white h4 para capi">my website</h5>
              ...
              <span className="text-muted para capi">
          ...
          <div className="container-fluid">
            <button
              className="navbar-toggler show capi para"
              type="button"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-border-width" viewBox="0 0 16 16">
  <path d="M0 3.5A.5.5 0 0 1 .5 3h15a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H.5a.5.5 0 0 1-.5-.5v-2zm0 5A.5.5 0 0 1 .5 8h15a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H.5a.5.5 0 0 1-.5-.5v-1zm0 4a.5.5 0 0 1 .5-.5h15a.5.5 0 0 1 0 1H.5a.5.5 0 0 1-.5-.5z"/>
</svg>
  </button>

  <div className="collapse show bg-dark" id="collapseExample">
  ...
  <div className="bg-dark p-4">
              ...
              <h5 className="para capi my-3">
                ...
                my database the password are 'salted'(added more securly).
                 <br/>
                <a className=" link link-secondary link-underline-dark h6 mt-2 mb-4 " title="Click hear to see the Frontend of my project" href="https://github.com/jayeshpatelswami/Mernnotebookfrontend" target="_blank" rel="noreferrer">  Code : 1 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey" className="bi bi-file-earmark-code-fill" viewBox="0 0 16 16">
  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM6.646 7.646a.5.5 0 1 1 .708.708L5.707 10l1.647 1.646a.5.5 0 0 1-.708.708l-2-2a.5.5 0 0 1 0-.708l2-2zm2.708 0 2 2a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708-.708L10.293 10 8.646 8.354a.5.5 0 1 1 .708-.708z"/>
</svg>  </a>
                <a className="  link link-secondary link-underline-dark h6 mt-2 mb-4 mx-3  " title="Click hear to see the backend of my project"  href="https://github.com/jayeshpatelswami/mernnotebookbackend" target="_blank" rel="noreferrer">  Code : 2 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey" className="bi bi-file-earmark-code-fill" viewBox="0 0 16 16">
  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM6.646 7.646a.5.5 0 1 1 .708.708L5.707 10l1.647 1.646a.5.5 0 0 1-.708.708l-2-2a.5.5 0 0 1 0-.708l2-2zm2.708 0 2 2a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708-.708L10.293 10 8.646 8.354a.5.5 0 1 1 .708-.708z"/>
</svg>  </a>
              </h5>
              <h5 className="para capi my-3">
                ...
                with the singal click.
                <br/>
                <a className=" link link-secondary link-underline-dark h6 mt-2 mb-4 " href="https://github.com/jayeshpatelswami/text_converter" target="_blank" rel="noreferrer">  Code  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey" className="bi bi-file-earmark-code-fill" viewBox="0 0 16 16">
  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM6.646 7.646a.5.5 0 1 1 .708.708L5.707 10l1.647 1.646a.5.5 0 0 1-.708.708l-2-2a.5.5 0 0 1 0-.708l2-2zm2.708 0 2 2a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708-.708L10.293 10 8.646 8.354a.5.5 0 1 1 .708-.708z"/>
</svg>  </a>
              </h5>
              <h5 className="para capi my-3">
                ...
                <br/>
                <a className=" link link-secondary link-underline-dark h6 mt-2 mb-4 " href="https://github.com/jayeshpatelswami/patel_akhbar_newsapp" target="_blank" rel="noreferrer">  Code  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey" className="bi bi-file-earmark-code-fill" viewBox="0 0 16 16">
  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM6.646 7.646a.5.5 0 1 1 .708.708L5.707 10l1.647 1.646a.5.5 0 0 1-.708.708l-2-2a.5.5 0 0 1 0-.708l2-2zm2.708 0 2 2a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708-.708L10.293 10 8.646 8.354a.5.5 0 1 1 .708-.708z"/>
</svg>  </a>
              </h5>
              <h5 className="para capi my-3">
                ...
                <br/>
                <a className=" link link-secondary link-underline-dark h6 mt-2 mb-4 " href="https://github.com/jayeshpatelswami/Portfoliomay2023" target="_blank" rel="noreferrer">  Code  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey" className="bi bi-file-earmark-code-fill" viewBox="0 0 16 16">
  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM6.646 7.646a.5.5 0 1 1 .708.708L5.707 10l1.647 1.646a.5.5 0 0 1-.708.708l-2-2a.5.5 0 0 1 0-.708l2-2zm2.708 0 2 2a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708-.708L10.293 10 8.646 8.354a.5.5 0 1 1 .708-.708z"/>
</svg>  </a>
              </h5>
